...
/**
 * PATCH /api/images/[id]
 * Update image metadata. Body: { title?, caption?, symbolism?, image_url? }
 */
export async function PATCH(
  ...
  const allowedFields = ["title", "caption", "symbolism", "image_url"];
...
export async function DELETE(
  ...
  // Delete the database record (storage cleanup handled separately if needed)
